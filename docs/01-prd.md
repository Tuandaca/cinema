# 01. Product Requirements Document (PRD) - Modern Cinema Web App

## 1. Product Vision (Tầm nhìn sản phẩm)
Xây dựng một nền tảng đặt vé xem phim hiện đại, mượt mà và thông minh, giúp người dùng không chỉ đặt vé nhanh chóng mà còn nhận được sự hỗ trợ cá nhân hóa từ AI, mang lại trải nghiệm điện ảnh trọn vẹn từ lúc chọn phim đến khi vào rạp.
...
- **Cinematic UI:** Hiệu ứng chuyển cảnh mượt mà, trailer tự động phát.
