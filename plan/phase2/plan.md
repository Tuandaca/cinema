...
### 4. Business Data Initialization (TMDB Sync)
- Tích hợp TMDB API để lấy dữ liệu phim thực tế (Region: VN, Language: vi).
- Xây dựng cơ chế "Sync & Store" để đồng bộ dữ liệu về Database cá nhân.
